      ...
      child: Column(
        children: [
          ...
          _buildReportCard('SKU Wise',
              ['White Cement', 'WCP', 'VAP', 'VAP (SKU Wise)'], cardWidth),
          SizedBox(height: 12),
        ...
        children: [
          ...
          Table(
            border: TableBorder.all(
                ...
                width: 1), // Outlined border for table
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text('YTD : Year To Date (from 01-Apr-2022 To 09-Feb-2023)',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
              Text('MTD : Month To Date (from 01-Feb-2023 To 09-Feb-2023)',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
              Text('MOM : Month on Month (Compare with last Month)',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
            ],
          ),
          SizedBox(height: 8),
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              fontWeight: selectedCategory == category
                  ? FontWeight.bold
                  : FontWeight.normal,
              color: selectedCategory == category ? Colors.blue : Colors.red,
            ),
          ),
        );
      }).toList(),
            ...
            child: DataTable(
              ...
              border: TableBorder(
                horizontalInside: BorderSide(
                    color: Colors.black54, width: 0.7), // Divider between rows
                verticalInside: BorderSide(
                    color: Colors.black54,
                    width: 0.7), // Divider between columns
              ),
              columns: [
                DataColumn(
                    label: Text('Zone',
                ...
                DataColumn(
                    label: Text('CYTD Sale',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('LYTD Sale',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('CY MTD',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('LY MTD',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('Previous Day Sale',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('MOM Sale (Jan 2023)',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('YTD Delta',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('MTD Delta',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('MOM Delta',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('Month SnOP',
                        style: TextStyle(fontWeight: FontWeight.bold))),
                DataColumn(
                    label: Text('Month SnOP Ach%',
                        style: TextStyle(fontWeight: FontWeight.bold))),
              ],
              rows: [
                _buildDataRow('Central', '53354', '52234', '1922', '1508',
                    '272', '1076', '1120', '414', '845', '7762', '25'),
                _buildDataRow('East', '25461', '23004', '1093', '658', '125',
                    '527', '2457', '435', '566', '3359', '33'),
                _buildDataRow('North', '46161', '42685', '1174', '934', '131',
                    '1226', '3476', '240', '-52', '6167', '19'),
                _buildDataRow('South', '76379', '73640', '2064', '2088', '355',
                    '1889', '2739', '-24', '175', '9210', '22'),
                _buildDataRow('West', '53255', '51008', '1465', '1385', '242',
                    '968', '2246', '80', '496', '6609', '22'),
                _buildDataRow('Export Int.', '64', '58', '-', '-', '-', '-',
                    '6', '-', '-', '-', '-'),
                _buildDataRow('Export Nepal', '911', '1490', '27', '-', '-',
                    '81', '-579', '27', '-54', '197', '14'),
                _buildDataRow('Grand Total', '255584', '244120', '7744', '6572',
                    '1125', '5767', '11465', '1172', '1977', '33304', '23'),
              ],
            ),
          ),
        ),
