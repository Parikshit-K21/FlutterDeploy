    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDropdownField(
              'Purchaser / Retailer', ['Purchaser', 'Retailer']),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8.0),
              _buildDropdownField(
                  'KYC Status', ['Complete', 'Pending', 'Yet to Start']),
              _buildDateField('Report Date*'),
              _buildTextField('Market Name (Location or Name)*'),
              _buildClickableOptions(
                  'Participation of Display Contest*', ['Yes', 'NO', 'NA']),
              _buildClickableOptions(
                  'Any Pending Issues (Yes / No)*', ['Yes', 'NO']),
          ...
          children: options.map((option) {
            ...
            return ChoiceChip(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                  color:
                      const Color.fromRGBO(0, 112, 183, 1), // Optional border
                ),
              ),
            );
          }).toList(),
