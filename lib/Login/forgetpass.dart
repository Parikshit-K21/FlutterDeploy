                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (errorMessage != null && !isResetLinkSent) ...[
                                const SizedBox(height: 16),
                                Text(
                                  errorMessage,
                                  style: const TextStyle(
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: isLoading || isResetLinkSent 
                                      ? null 
                                      : _sendResetLink,
                                  ...
                                  child: isLoading
                                      ...
                                      : Text(
                                          isResetLinkSent ? 'Back to Login' : 'Reset Password',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 16,
                                          ),
                              ...
                              if (isResetLinkSent) ...[
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      ref.read(isResetLinkSentProvider.notifier).state = false;
                                    },
