...
class AppTheme {
  ...
  const AppTheme({
    ...
    this.primaryLightColor = const Color(0xFF58a5f0),
    this.primaryDarkColor = const Color(0xFF004c8c),
    this.onPrimaryColor = Colors.white,
    
    // Secondary color
    this.secondaryColor = const Color(0xFF26A69A),
    this.secondaryLightColor = const Color(0xFF64d8cb),
    this.secondaryDarkColor = const Color(0xFF00766c),
  ...
  ThemeData toThemeData() {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineMedium: TextStyle(fontSize: fontSizes.large, color: textColor, fontWeight: FontWeight.bold),
        titleLarge: TextStyle(fontSize: fontSizes.medium, color: textColor, fontWeight: FontWeight.bold),
        ...
        labelLarge: TextStyle(fontSize: fontSizes.small, color: textColor, fontWeight: FontWeight.bold),
      ),
      cardTheme: CardTheme(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        contentPadding: EdgeInsets.symmetric(horizontal: spacing.medium, vertical: spacing.medium),
      ),
...
double getResponsiveFontSize(BuildContext context, double fontSize) {
  ...
  return fontSize * (scaleFactor > 1.2 ? 1.2 : (scaleFactor < 0.8 ? 0.8 : scaleFactor));
}
...
extension ThemeExtension on BuildContext {
  ...
  double responsiveFontSize(double fontSize) => getResponsiveFontSize(this, fontSize);
}